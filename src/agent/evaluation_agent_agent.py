"""Evaluation Agent - Main Agent Implementation."""
...
class EvaluationAgentAgent:
    ...
    def __init__(self):
        ...
        self.eval_design_enabled = True
        self.benchmark_comparison_enabled = True
        self.regression_testing_enabled = True
        self.safety_evaluation_enabled = True
        self.cost_analysis_enabled = True
        self._tool_dispatch = {
            "create_eval_suite": self.tools.create_eval_suite,
            "run_evaluation": self.tools.run_evaluation,
            "compare_models": self.tools.compare_models,
            "run_safety_eval": self.tools.run_safety_eval,
        ...
        logger.info(
            ...
            features=['eval_design', 'benchmark_comparison', 'regression_testing', 'safety_evaluation', 'cost_analysis'],
        )
    ...
    async def _maybe_execute_tools(self, message: str, context: str) -> list[dict]:
        ...
        tool_keywords = {
            "create_eval_suite": ['create', 'eval', 'suite'],
            "run_evaluation": ['run', 'evaluation'],
            "compare_models": ['compare', 'models'],
            "run_safety_eval": ['run', 'safety', 'eval'],
